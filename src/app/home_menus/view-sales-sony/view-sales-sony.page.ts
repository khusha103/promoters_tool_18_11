...
//   quantity: string; // or number if you prefer
//   total: string; // or number if you prefer
// }
...
//   salesData: Sale[] = []; // Use the Sale interface
...
//   userRole: number | null = Number(localStorage.getItem('roleId')) || null;

//   // feedbackData!: Feedback | null; // To hold the feedback data
//   errorMessage!: string | null;


//   constructor(private apiService: ApiService, private userService: UserService, private alertController: AlertController) { }
...
//   // const url = `https://ekarigartech.com/erp/App_api/ownsales_xls/${countryId}/${retailerId}/${storeId}/${categoryId}/${modelId}/${promoterId}/${fromDate}/${toDate}`;
//   const url =`${environment.apiBaseUrl}/App_api/{countryId}/${retailerId}/${storeId}/${categoryId}/${modelId}/${promoterId}/${fromDate}/${toDate}`;
        ...
        this.authservice.getUserRole(UserId).subscribe({
          next: (response) => {
            if (response.status) {
              ...
              // console.log('roleið',this.userRole);
